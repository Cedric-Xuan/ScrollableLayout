...
public class PageOne extends RelativeLayout{
    ...
    public PageOne(Context context, AttributeSet attributes, int defStyle){
        super(context,attributes,defStyle);
        initView();
    }

    public PageOne(Context context, AttributeSet attributes){
